...
const Socials = ({ social, link, linkTitle, buttonTitle }) => {
  let socialIcon = <GitHubIcon />;
  if (social === "linkedin") socialIcon = <LinkedInIcon />;
  else if (social === "email") socialIcon = <EmailIcon />;
  else if (social === "discord") socialIcon = <DiscordIcon />;
  else if (social === "facebook") socialIcon = <FacebookIcon />;

  return (
    <a
      href={link}
      target={social !== "email" ? "_blank" : "_self"}
      rel="noreferrer"
      title={linkTitle}
    >
      <IconButton
